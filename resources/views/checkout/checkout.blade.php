         ...
         @if(true)
            <div class="checkout-steps" >
               ...
               <section class="section shipping active">
                    <label class="step" data-toggle="collapse" data-target="#shippping-address">Shipping Address</label>
                ...
                <section class="section summary">
                    <label class="step" data-toggle="collapse" data-target="#summary">Order Summary</label>
                ...
                <section class="section payment">
                    <label class="step" data-toggle="collapse" data-target="#payment-method">Choose Payment Option</label>
