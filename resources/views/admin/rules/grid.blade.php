...
<div class="right-side" >
    ...
    <div class="action-bar">
            ...
            <span class="add-new">
                    <a href="/admin/catalog_rule/create"><button class="btn btn-success btn-responsive"><i class="fa fa-plus" aria-hidden="true"></i> Add </button></a>
             </span>
    </div>
	<div class="wrapper">
		<table class="table table-bordered">
			...
			@foreach($collection as $set ) 
				<tr>
					...
					<td>
						<a href="/admin/catalog_rule/{{$set ->id}}/edit">
